...
/* package currencyConv-0.1.0.0 */
#define VERSION_currencyConv "0.1.0.0"
#define MIN_VERSION_currencyConv(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "currencyConv-0.1.0.0"

#define CURRENT_PACKAGE_KEY "currencyConv-0.1.0.0"
